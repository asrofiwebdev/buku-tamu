...
<head>
    ...
    <title>Halaman Login | Sistem Informasi Buku Tamu Asfahany's Tech</title>
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5 text-center">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-lg-block bg-dark shadow-lg p-5">
                                <img src="assets/img/logo.png" width="50%">
                                <h3 class="text-white">
                                    <br>
                                    Sistem Informasi Buku Tamu
                                    <br> Asfahany's <b>Tech</b>
                                    <br> <small>Jabung, Malang</small>
                                </h3>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
